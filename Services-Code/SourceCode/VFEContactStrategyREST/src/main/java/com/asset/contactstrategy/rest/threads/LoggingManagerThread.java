...
public class LoggingManagerThread implements Runnable {
    ...
    public void run() {
        ...
        while (!ConfigurationManager.SHUTDOWN_FLAG || !ConfigurationManager.requestsToBeLogged.isEmpty()
                || ConfigurationManager.concurrentRequests.get() > 0) {
            try {
...
//                + " || PullTimeOut: " + pullTimeOut + " || MAX_NUM_OF_RETRIES_LTHREAD: " + MAX_NUM_OF_RETRIES_LTHREAD + " || MAX_LOGGING_DB_ARRAY_SIZE: "
//                + MAX_LOGGING_DB_ARRAY_SIZE);
