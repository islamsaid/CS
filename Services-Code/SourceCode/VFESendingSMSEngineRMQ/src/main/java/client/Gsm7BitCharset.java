...
//                    System.out.println("Encoding ch " + ch + " to byte " + b);
                    CommonLogger.businessLogger.debug(StructuredLogFactory.put(GeneralConstants.StructuredLogKeys.MESSAGE, "Trying Extended Map to Encode char to byte")
                            .put(GeneralConstants.StructuredLogKeys.CHAR, ch)
                            .put(GeneralConstants.StructuredLogKeys.BYTE, b).build());
                }
                if (b != null) {
                    ...
                    if (debug) {
//                        CommonLogger.businessLogger.debug("Trying extended map to encode ch " + ch + " to byte " + b);
                        CommonLogger.businessLogger.debug(StructuredLogFactory.put(GeneralConstants.StructuredLogKeys.MESSAGE, "Trying Extended Map to Encode char to byte")
                                .put(GeneralConstants.StructuredLogKeys.CHAR, ch)
                                .put(GeneralConstants.StructuredLogKeys.BYTE, b).build());
                    }
...
//                    System.out.println("Looking up byte " + b);
                    CommonLogger.businessLogger.debug(StructuredLogFactory.put(GeneralConstants.StructuredLogKeys.MESSAGE, "Looking up byte")
                            .put(GeneralConstants.StructuredLogKeys.BYTE, b).build());
                }
...
//                            System.out.println("Found string " + s);
                            CommonLogger.businessLogger.debug(StructuredLogFactory.put(GeneralConstants.StructuredLogKeys.MESSAGE, "Found string")
                                    .put(GeneralConstants.StructuredLogKeys.STRING, s).build());
                        }
                        cb.put(ch);
                    } else {
                        if (debug) {
//                            System.out.println("Found escape character");
                            CommonLogger.businessLogger.debug(StructuredLogFactory.put(GeneralConstants.StructuredLogKeys.MESSAGE, "Found Excape Character").build());
