 ...
 * @author islam.said
 */
public class SarSegmentsSeqnum extends CommandParam {

    private Integer length;

    private Integer value;

    public SarSegmentsSeqnum(BufferByte pdu) {
        super(pdu);
    }
    ...
    public void parsePDU(BufferByte pdu) {
        ...
        value = Utility.convertSignedByteToInt(pdu.removeByte());
    }
    ...
    public boolean equals(Object obj) {
        ...
        SarSegmentsSeqnum other = (SarSegmentsSeqnum) obj;
        if (length == null) {
