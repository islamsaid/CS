...
public class LivenessController {
    ...
    @RequestMapping(value = "/InterfaceLiveness", method = RequestMethod.GET)
...
//        CommonLogger.businessLogger.info("Starting handling request for InterfaceLiveness with trans_id=" + request.getAttribute("transId") + ",total count:" + ManagerBean.livenessControllerTotalCount.incrementAndGet() + ",application concurrent count:" + ManagerBean.concurrentCount.incrementAndGet());
        CommonLogger.businessLogger.info(StructuredLogFactory.put(GeneralConstants.StructuredLogKeys.MESSAGE, "Starting handling request for InterfaceLiveness")
                .put(GeneralConstants.StructuredLogKeys.TRANS_ID, request.getAttribute("transId").toString())
                .put(GeneralConstants.StructuredLogKeys.TOTAL_COUNT, ManagerBean.livenessControllerTotalCount.incrementAndGet())
        ...
        threads.put("reloadingThread", managerBean.getReloadingThread());
        threads.put("monitorThread", managerBean.getMonitorThread());
        ArrayList<Boolean> flags = new ArrayList<>();
        flags.add(ManagerBean.DEQUEUER_SERVICE_SHUTFOWN_FLAG.get());

        if (!Utility.checkInterface(flags, null, null, threads, CommonLogger.businessLogger)) {
...
//        CommonLogger.businessLogger.info("Ending request for InterfaceLiveness with trans_id=" + request.getAttribute("transId") + ",responseCode:" + responseModel.getCode() + "responseDescription:" + responseModel.getDescription() + "success count:" + ManagerBean.livenessControllerSuccessCount.incrementAndGet() + ",application concurrent count:" + ManagerBean.concurrentCount.decrementAndGet());
        CommonLogger.businessLogger.info(StructuredLogFactory.put(GeneralConstants.StructuredLogKeys.MESSAGE, "Ending request for InterfaceLiveness")
                .put(GeneralConstants.StructuredLogKeys.TRANS_ID, request.getAttribute("transId").toString())
                ...
                .put(GeneralConstants.StructuredLogKeys.SUCCESS_COUNT, ManagerBean.livenessControllerSuccessCount.incrementAndGet())
...
//        CommonLogger.businessLogger.info("Ending request for InterfaceLiveness with trans_id=" + request.getAttribute("transId") + ",responseCode:" + responseModel.getCode() + "responseDescription:" + responseModel.getDescription() + "failure count:" + ManagerBean.livenessControllerFailureCount.incrementAndGet() + ",application concurrent count:" + ManagerBean.concurrentCount.decrementAndGet());
        CommonLogger.businessLogger.error(StructuredLogFactory.put(GeneralConstants.StructuredLogKeys.MESSAGE, "Ending request for InterfaceLiveness")
                ...
                .put(GeneralConstants.StructuredLogKeys.RESPONSE_CODE, responseModel.getCode())
                .put(GeneralConstants.StructuredLogKeys.RESPONSE_DESCRIPTION, responseModel.getDescription())
                .put(GeneralConstants.StructuredLogKeys.FAILURE_COUNT, ManagerBean.livenessControllerFailureCount.incrementAndGet())
                .put(GeneralConstants.StructuredLogKeys.CONCURRENT_COUNT, ManagerBean.concurrentCount.decrementAndGet()).build());
